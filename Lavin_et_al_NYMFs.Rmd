...
R = ggplot(R.success.ratio, aes(x = range, y = `50%`)) +
  geom_ribbon(aes(ymin = `2.5%`, ymax = `97.5%`), fill = "deepskyblue1", alpha = .4) +
...
ntmr.plot = ggplot(ntmr.zones[[1]] %>% spread(key = quantile, value = value), 
    ...
    scale_y_continuous(expand = c(0,0)) +
    scale_x_continuous(breaks = c(0, 10, 20, 30, 38, 50, 60, 70, 80), limits = c(0,80), labels = c("0", "10", "20", "30", "38", "50", "60", "70", "80")) +
