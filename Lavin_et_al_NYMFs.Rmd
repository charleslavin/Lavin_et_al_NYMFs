...
Fig2a =  ggplot() + 
  ...
  scale_x_continuous(breaks = seq(25,80,5), labels = c("≤25", "26-30", "31-35", "36-40", "41-45", "46-50", "51-55", "56-60", "61-65", "66-70", "71-75", "76-80"), limits=c(25,80)) +
...
# # of NYMF vs # of above-MSL from UVC
```{r}
...
ntmr.plot = ggplot(ntmr.zones[[1]] %>% spread(key = quantile, value = value), 
                    aes(y = `50%`, x = range)) +
    geom_histogram(data = data.frame(x = ntmr$TOTAL.LENGTH), aes(x = x, y=..density..), binwidth=5, colour="black", fill="grey66", alpha = .3) + 
    geom_ribbon(aes(ymin = `2.5%`, ymax = `97.5%`), fill = "grey78", alpha = .5) +
    geom_line(col = "grey66") +
    scale_y_continuous(expand = c(0,0)) +
    scale_x_continuous(breaks = seq(0,80,5), labels = c("", "6-10", "", "16-20", "", "25-30", "", "36-40", "", "46-50", "", "56-60", "", "66-70", "", "76-80", ""), limits=c(0,80)) +
